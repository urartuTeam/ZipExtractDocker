                ...
                <nav className="sidebar-nav">
                    <ul>
                        ...
                        <li><NavLink to="/employees" className={({isActive}) => isActive ? 'active' : ''}>👥
                            Сотрудники</NavLink></li>
                        <li><NavLink to="/departments" className={({isActive}) => isActive ? 'active' : ''}>🏢
                            Отделы</NavLink></li>
                        <li><NavLink to="/positions" className={({isActive}) => isActive ? 'active' : ''}>💼
                            Должности</NavLink></li>
                        <li><NavLink to="/projects" className={({isActive}) => isActive ? 'active' : ''}>📋
                            Проекты</NavLink></li>
                        <li><NavLink to="/leaves" className={({isActive}) => isActive ? 'active' : ''}>📅
                            Отпуска</NavLink></li>
                    </ul>
                </nav>
